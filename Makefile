...
help:
	...
	@echo "  make test-full-setup - FULL RESET + setup + tenant + product + image test"
	...
	@echo ""
	@echo "Image Tests:"
	@echo "  make create-test-image     - Create test image (1x1 pixel JPEG)"
	@echo "  make test-images-complete  - Complete end-to-end workflow test"
	@echo "  make test-image-upload     - Upload to product (PRODUCT_ID=uuid)"
	@echo "  make test-image-list       - List images (PRODUCT_ID=uuid)"
	@echo "  make test-image-get        - Get image (IMAGE_ID=uuid)"
	@echo "  make test-image-update     - Update metadata (IMAGE_ID=uuid)"
